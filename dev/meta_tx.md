...
https://github.com/circlelayer Blockchain/metatx-Java-demo
...
Circle Layer Blockchain officially provides a meta transaction service with a fee subsidy based on the caller's `BTC` holdings.
...
https://meta-mainnet.circlelayer.com
