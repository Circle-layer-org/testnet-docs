# Contract
`Circle Layer Blockchain` uses `EVM` for contract execution.See [Solidity](https://docs.soliditylang.org/en/v0.7.1/#) for detail.
...
![avatar](../images/Add-custome-Network.png)
